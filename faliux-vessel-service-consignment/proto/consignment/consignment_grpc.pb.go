...
const (
	Shipping_CreateConsignment_FullMethodName = "/consignment.Shipping/CreateConsignment"
)
...
func (c *shippingClient) CreateConsignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Response, error) {
	...
	out := new(Response)
	err := c.cc.Invoke(ctx, Shipping_CreateConsignment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Shipping_CreateConsignment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Shipping_CreateConsignment_FullMethodName,
	}
